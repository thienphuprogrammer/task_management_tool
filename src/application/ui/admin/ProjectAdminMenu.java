        ...
        try {
            ...
            if (project != null) {
                ...
                for (ReportProject reportProject : reportProjects) {
                    printValue("id: " + reportProject.getId() + " ".repeat(10 - String.valueOf(reportProject.getId()).length()) + "|");
                    printValue("time: " + reportProject.getTime() + " ".repeat(20 - String.valueOf(reportProject.getTime()).length()) + "|");
                    printValue("date: " + reportProject.getDate() + " ".repeat(20 - String.valueOf(reportProject.getDate()).length()) + "|");
                    printValue("description: " + reportProject.getDescription() + " ".repeat(30 - String.valueOf(reportProject.getDescription()).length()) + "|");
                    printValueln("Project id: " + reportProject.getProject_id() + " ".repeat(10 - String.valueOf(reportProject.getProject_id()).length()) + "|");
                }
            } else {
                printValueln("Project not found.");
            }
